...
class ContactsFormat: NSObject, NSCoding {
    ...
    init(name: String, lastName: String?, number: String?, photo: Data?, notes: String?) {
        self.name = name
    ...
    required init?(coder: NSCoder) {
        ...
        self.photo = coder.decodeObject(forKey: "photo") as? Data
...
//        let contacts = NSKeyedUnarchiver.unarchivedObject(ofClasses: ContactsFormat, from: encodedData)// as? [ContactsFormat]
    ...
    static func addNewContact(firstName: String, lastName: String, number: String, photo: Data?, notes: String) -> ContactsFormat{
